...
![Agent Skills Architecture - showing how Skills integrate with the agent's configuration and virtual machine](/images/docs/agent-skills-overview/agent-skills-architecture.png)
...
![Skills loading into context window - showing the progressive loading of skill metadata and content](/images/docs/agent-skills-overview/agent-skills-context-window.png)
