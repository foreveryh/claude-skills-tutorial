...
Step 4: philosophical-illustrator generates visuals
  ...
  → Saves to /public/images/docs/analyzing-mcp-builder/
...
<Files>
  <Folder name="philosophical-illustrator">
    <File name="SKILL.md" description="SVG generation rules, color palettes, and output specifications" />
  </Folder>
</Files>
...
<Cards>
  ...
  <Card
    ...
    description="Generate custom SVG cover images tailored to each article's theme"
    icon="Palette"
  />
  <Card
