...
author: "Anthropic"
image: "/assets/img/agent-skills-sdk.svg"
source:
  url: "https://docs.claude.com/en/docs/agent-sdk/skills"
...
**Original Article**: [Link](https://docs.claude.com/en/docs/agent-sdk/skills)
