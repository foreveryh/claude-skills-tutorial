...
<Tabs items={['Samples 1-4', 'Samples 5-8', 'Samples 9-11']}>
  <Tab value="Samples 1-4">
    **1. Indirect Execution**
    ```python
...
✅ **40+ Detection Patterns** covering command injection, YAML injection, credential theft, and more
✅ **100% Test Suite Detection** on 11 malicious samples
✅ **6-Phase Analysis** including YAML parsing, import analysis, and data flow tracking
✅ **Advanced Evasion Detection** for indirect execution, encoding, and obfuscation
