...
**创新点**：与通用库存图片不同，每个插图都与其文章**语义连接**。当你看到蓝色背景配浏览器和对勾，你立即认出这是关于测试的。橙色配代码括号？那是前端开发。
...
步骤 4：philosophical-illustrator 生成视觉效果
  ...
  → 保存到 /public/images/docs/analyzing-mcp-builder/
...
<Files>
  <Folder name="philosophical-illustrator">
    <File name="SKILL.md" description="SVG 生成规则、调色板和输出规范" />
  </Folder>
</Files>
...
<Cards>
  ...
  <Card
    ...
    description="生成针对每篇文章主题定制的自定义 SVG 封面图片"
    icon="Palette"
  />
  <Card
