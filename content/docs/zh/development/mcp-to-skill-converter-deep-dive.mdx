...
**仓库**：[https://github.com/GBSOSS/-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)
**许可证**：MIT（开源，宽松）
...
- **作者**：GBSOSS
- **仓库**：[github.com/GBSOSS/-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)
