...
![使用基本提示的字体排印示例](/images/docs/improving-frontend-design-through-skills/typography-base.png)

**使用基本提示和字体排印部分生成的输出**

![使用增强提示的字体排印示例](/images/docs/improving-frontend-design-through-skills/typography-enhanced.png)
...
![RPG主题UI示例](/images/docs/improving-frontend-design-through-skills/rpg-theme-ui.png)
...
![使用基本提示的SaaS登录页面](/images/docs/improving-frontend-design-through-skills/saas-base.png)

**标题：** AI生成的SaaS登录页面，具有通用Inter字体、紫色渐变和标准布局。没有使用技能。

![使用前端技能的SaaS登录页面](/images/docs/improving-frontend-design-through-skills/saas-enhanced.png)

**标题：** 使用与上述渲染相同的提示以及前端技能生成的AI生成前端，现在具有独特的字体排印、连贯的配色方案和分层背景。

**示例2：博客布局**

![使用基本提示的博客布局](/images/docs/improving-frontend-design-through-skills/blog-base.png)

AI生成的博客布局，具有默认系统字体和平坦白色背景。没有使用技能。

![使用前端技能的博客布局](/images/docs/improving-frontend-design-through-skills/blog-enhanced.png)

AI生成的博客布局，使用相同的提示以及前端技能，具有编辑风格字体、大气深度和精致间距。

**示例3：管理仪表板**

![使用基本提示的管理仪表板](/images/docs/improving-frontend-design-through-skills/dashboard-base.png)

AI生成的管理仪表板，具有标准UI组件和最小视觉层次。没有使用技能。

![使用前端技能的管理仪表板](/images/docs/improving-frontend-design-through-skills/dashboard-enhanced.png)
...
![使用基本提示的白板应用](/images/docs/improving-frontend-design-through-skills/whiteboard-base.png)

另一方面，当使用新的web-artifacts-builder技能时，Claude生成了一个更清晰、功能更丰富的开箱即用应用程序，包括绘制不同的形状和文本：

![使用web-artifacts-builder技能的白板应用](/images/docs/improving-frontend-design-through-skills/whiteboard-enhanced.png)

**示例2：任务管理器应用**

同样，当被要求创建任务管理应用时，没有技能，Claude生成了一个功能非常最少的应用程序：

![使用基本提示的任务管理器应用](/images/docs/improving-frontend-design-through-skills/taskmanager-base.png)

使用技能，Claude生成了一个开箱即用功能更丰富的应用程序。例如，Claude包含了一个"创建新任务"表单组件，允许用户为任务设置相关类别和截止日期：

![使用web-artifacts-builder技能的任务管理器应用](/images/docs/improving-frontend-design-through-skills/taskmanager-enhanced.png)

![任务管理器表单组件](/images/docs/improving-frontend-design-through-skills/taskmanager-form.png)
